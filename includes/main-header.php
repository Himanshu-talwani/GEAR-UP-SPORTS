...
<div class="logo">
	<a href="index.php">
		...
		<h3 style="color: darkred;"  onmouseover="this.style.color='green'" onmouseout="this.style.color='darkred'">  <img src="img/perfect2.png" alt="Gear Icon" width="90" height="90" > Gear-Up Sports </h3>
