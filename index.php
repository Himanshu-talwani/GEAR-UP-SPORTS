			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h5 class="info-box-heading orange">3-DAYS  delivery
							</h5>
						</div>
					</div>
					<h6 class="text"> Guaranted super fast shipping</h6>	
				</div>
			</div><!-- .col -->
...
<?php }?>
	...
	<div> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSeEkLcERPD0PHvIC3pVfVhbf78oJVf0km10iWvkfZ10v-akP_defbyRL29fT8ZsHUvNg&usqp=CAU" alt="" style=" height: 150px; weigth: 100px; position: relative; left: 600px; bottom: 300px;"></div>
				                   	</div>
	                   </section>
