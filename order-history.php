		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-description item">Invoice</th>
...
<td>
    <a href="download_invoice.php?orderid=<?php echo $row['orderid']; ?>" title="Download Invoice" class="btn btn-primary">Download Invoice</a>
</td>
